...
var RelaySyncSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("URL \u0441\u0435\u0440\u0432\u0435\u0440\u0430").setDesc("\u0410\u0434\u0440\u0435\u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u0430-\u043C\u0430\u0440\u0448\u0440\u0443\u0442\u0438\u0437\u0430\u0442\u043E\u0440\u0430 \u0434\u043B\u044F \u0441\u0438\u043D\u0445\u0440\u043E\u043D\u0438\u0437\u0430\u0446\u0438\u0438").addText(
      (text) => text.setPlaceholder("wss://relay-server.example.com").setValue(this.plugin.settings.serverUrl).onChange(async (value) => {
